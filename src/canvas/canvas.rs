...
pub fn Canvas() -> Element {
    ...
    rsx! {
            ...
            // body {
                div{
                    class:"md:w-1/2 md:h-[600px] mt-[100px] ml-[1px] mr-[1px] bg-red-100",
                    div{
                        class:"font-helvetica font-thin text-[50px]",
                        "Canvas"
...
pub fn ReadDomain() -> Element {
    ...
    rsx! {
        ...
        div{
            class:"mt-20 flex flex-col w-full h-screen ",
            p{
                class:"mt-10",
                "Domain name: "
                span{
